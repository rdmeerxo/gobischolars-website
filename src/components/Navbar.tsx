        ...
        <div className="flex items-center justify-between h-20">
          ...
          <Link to={isFoundation ? '/foundation' : (isLoggedIn ? '/academy/dashboard' : '/academy')} className="flex items-center gap-4 group md:hidden">
            <div className="flex flex-col">
              <img
                src={isFoundation ? '/src/assets/GOBISCHOLARS_FOUNDATION.svg' : '/src/assets/GOBISCHOLARS_ACADEMY.svg'}
          ...
          {isFoundation ? (
            <>
              ...
              >
                <img
                  src="/src/assets/GOBISCHOLARS_FOUNDATION.svg"
            ...
            <>
              ...
              >
                <img
                  src="/src/assets/GOBISCHOLARS_ACADEMY.svg"
