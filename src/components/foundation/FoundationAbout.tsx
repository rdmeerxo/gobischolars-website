...
<br/>
          ...
          <div className="grid md:grid-cols-2 gap-10 mb-20">
            <img src="/src/assets/about12scholar.svg" alt="Scholars Group 1" className="w-full h-80 object-cover rounded" />
            <img src="/src/assets/about12scholar1.svg" alt="Scholars Group 2" className="w-full h-80 object-cover rounded" />
          </div>
      ...
      <section className="py-32 px-8 lg:px-16 bg-white text-center">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto mt-8 mb-12">
            <ImageWithFallback
              src="/src/assets/about_future.svg"
              alt="Future vision"
