    ...
    <div className="bg-white">
      ...
      <section className="relative h-screen min-h-[800px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <ImageWithFallback
            src="/src/assets/program_home page.svg"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
            ...
            <div className="space-y-6">
              <div className="overflow-hidden aspect-[4/3]">
                <ImageWithFallback
                  src="/src/assets/Mongolia_landscape.svg"
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="overflow-hidden aspect-square">
                  <ImageWithFallback
                    src="/src/assets/Traditional_yurt.svg"
                ...
                <div className="overflow-hidden aspect-square">
                  <ImageWithFallback
                    src="/src/assets/Group_photo.svg"
                    alt="Group photo"
                    className="w-full h-full object-cover"
                  />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="overflow-hidden aspect-[4/3] flex items-center justify-center">
                  <ImageWithFallback
                    src="/src/assets/about12scholar.svg"
                    alt="P_2"
                    className="w-full h-full object-cover"
                  />
                </div>
